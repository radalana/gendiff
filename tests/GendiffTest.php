...
class GendiffTest extends TestCase
{
    ...
    */
    ...
    public function testGendiffJson4()
    {
        ...
        $expected = file_get_contents('./tests/fixtures/jsonFiles/test4/expected.json');
        $this->assertEquals($expected, gendiff($jsonFile1, $jsonFile2));
    }

    public function testGendiffJson5()
    {
        $jsonFile1 = './tests/fixtures/jsonFiles/test5/file1.json';
        $jsonFile2 = './tests/fixtures/jsonFiles/test5/file2.json';
        $expected = file_get_contents('./tests/fixtures/jsonFiles/test5/expected.json');
        $this->assertEquals($expected, gendiff($jsonFile1, $jsonFile2));
    }
    ...
    public function testGendiffJsonFormat()
    {
        $jsonFile1 = './tests/fixtures/jsonFiles/test1/file1.json';
        $jsonFile2 = './tests/fixtures/jsonFiles/test1/file2.json';
        $expected = (file_get_contents('./tests/fixtures/jsonFiles/test1/expectedJson.json'));
        $expectedJsonfile = './tests/fixtures/jsonFiles/test1/expectedJson.json';
